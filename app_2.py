...
<head>
    ...
    {% raw %}
    <style>
        @import url('https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@500;600;700&family=IBM+Plex+Sans:wght@400;500&family=IBM+Plex+Mono:wght@400;500&family=Fredoka:wght@500;600;700&display=swap');
        ...
        * { box-sizing: border-box; }
        ...
        /* Walking cartoon cat that waves hello */
        #cat-wrap {
            position: fixed;
            bottom: 14px;
            width: 132px;
            ...
            z-index: 6;
            pointer-events: none;
            animation: catWalk 17s linear infinite;
        }
        @keyframes catWalk {
            0%   { left: -16%; }
            100% { left: 108%; }
        }
        .cat-bob { position: relative; width: 100%; height: 100%; animation: catBob 0.5s ease-in-out infinite alternate; }
        @keyframes catBob {
            from { transform: translateY(0); }
            to   { transform: translateY(-5px); }
        }

        .cat-tail { transform-box: fill-box; transform-origin: 100% 100%; animation: tailWag 1.1s ease-in-out infinite; }
        @keyframes tailWag {
            0%, 100% { transform: rotate(0deg); }
            50%      { transform: rotate(-18deg); }
        }

        .cat-paw-wave { transform-box: fill-box; transform-origin: 50% 100%; animation: pawWave 1.3s ease-in-out infinite; }
        @keyframes pawWave {
            0%, 100% { transform: rotate(0deg); }
        ...
        .cat-eye { transform-box: fill-box; transform-origin: 50% 50%; animation: catBlink 4.5s ease-in-out infinite; }
        @keyframes catBlink {
        ...
        .cat-speech {
            ...
            animation: bubblePop 1.3s ease-in-out infinite;
        }
        .cat-speech::after {
            content: "";
            position: absolute;
...
<body>
    ...
    <div id="cat-wrap">
        <div class="cat-bob">
            <div class="cat-speech">Hi! 👋</div>
            <svg viewBox="0 0 160 120" width="132" height="96" xmlns="http://www.w3.org/2000/svg">
                <path class="cat-tail" d="M118,78 C140,72 150,50 138,32 C132,24 122,26 122,36 C122,48 132,50 132,60 C132,70 122,76 112,80 Z" fill="#FF9E45"/>
                <ellipse cx="80" cy="82" rx="40" ry="26" fill="#FFA94D"/>
                <ellipse cx="80" cy="90" rx="24" ry="14" fill="#FFF3E0"/>
                <rect x="54" y="96" width="10" height="16" rx="5" fill="#FF9E45"/>
                <rect x="96" y="96" width="10" height="16" rx="5" fill="#FF9E45"/>
                <g class="cat-paw-wave">
                    <rect x="28" y="70" width="10" height="26" rx="5" fill="#FFA94D"/>
                </g>
                <circle cx="46" cy="52" r="26" fill="#FFA94D"/>
                <path d="M26,38 L18,14 L42,30 Z" fill="#FF9E45"/>
                <path d="M66,38 L78,14 L54,30 Z" fill="#FF9E45"/>
                <path d="M28,34 L24,20 L38,29 Z" fill="#FFD3A6"/>
                <path d="M64,34 L68,20 L54,29 Z" fill="#FFD3A6"/>
                <ellipse class="cat-eye" cx="37" cy="50" rx="4.2" ry="5.4" fill="#0A1128"/>
                <ellipse class="cat-eye" cx="55" cy="50" rx="4.2" ry="5.4" fill="#0A1128"/>
                <path d="M44,60 L48,60 L46,64 Z" fill="#F06292"/>
                <path d="M46,64 C43,68 39,68 37,65" fill="none" stroke="#7A4B1E" stroke-width="1.6" stroke-linecap="round"/>
                <path d="M46,64 C49,68 53,68 55,65" fill="none" stroke="#7A4B1E" stroke-width="1.6" stroke-linecap="round"/>
                <line x1="14" y1="50" x2="30" y2="48" stroke="#7A4B1E" stroke-width="1.2"/>
                <line x1="14" y1="56" x2="30" y2="56" stroke="#7A4B1E" stroke-width="1.2"/>
                <line x1="62" y1="48" x2="78" y2="50" stroke="#7A4B1E" stroke-width="1.2"/>
                <line x1="62" y1="56" x2="78" y2="56" stroke="#7A4B1E" stroke-width="1.2"/>
            </svg>
        </div>
    </div>
    {% endraw %}
